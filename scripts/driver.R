...
stan_data <- list(N = nrow(feature_matrix3),
                  y = feature_matrix3$group,
                  DN_HistogramMode_5 = feature_matrix3$DN_HistogramMode_5,
                  DN_HistogramMode_10 = feature_matrix3$DN_HistogramMode_10,
                  CO_f1ecac = feature_matrix3$CO_f1ecac,
                  CO_FirstMin_ac = feature_matrix3$CO_FirstMin_ac,
                  CO_HistogramAMI_even_2_5 = feature_matrix3$CO_HistogramAMI_even_2_5,
                  CO_trev_1_num = feature_matrix3$CO_trev_1_num,
                  MD_hrv_classic_pnn40 = feature_matrix3$MD_hrv_classic_pnn40,
                  SB_BinaryStats_mean_longstretch1 = feature_matrix3$SB_BinaryStats_mean_longstretch1,
                  SB_TransitionMatrix_3ac_sumdiagcov = feature_matrix3$SB_TransitionMatrix_3ac_sumdiagcov,
                  PD_PeriodicityWang_th0_01 = feature_matrix3$PD_PeriodicityWang_th0_01,
                  CO_Embed2_Dist_tau_d_expfit_meandiff = feature_matrix3$CO_Embed2_Dist_tau_d_expfit_meandiff,
                  IN_AutoMutualInfoStats_40_gaussian_fmmi = feature_matrix3$IN_AutoMutualInfoStats_40_gaussian_fmmi,
                  FC_LocalSimple_mean1_tauresrat = feature_matrix3$FC_LocalSimple_mean1_tauresrat,
                  DN_OutlierInclude_p_001_mdrmd = feature_matrix3$DN_OutlierInclude_p_001_mdrmd,
                  DN_OutlierInclude_n_001_mdrmd = feature_matrix3$DN_OutlierInclude_n_001_mdrmd,
                  SP_Summaries_welch_rect_area_5_1 = feature_matrix3$SP_Summaries_welch_rect_area_5_1,
                  SB_BinaryStats_diff_longstretch0 = feature_matrix3$SB_BinaryStats_diff_longstretch0,
                  SB_MotifThree_quantile_hh = feature_matrix3$SB_MotifThree_quantile_hh,
                  SC_FluctAnal_2_rsrangefit_50_1_logi_prop_r1 = feature_matrix3$SC_FluctAnal_2_rsrangefit_50_1_logi_prop_r1,
                  SC_FluctAnal_2_dfa_50_1_2_logi_prop_r1 = feature_matrix3$SC_FluctAnal_2_dfa_50_1_2_logi_prop_r1,
                  SP_Summaries_welch_rect_centroid = feature_matrix3$SP_Summaries_welch_rect_centroid,
                  FC_LocalSimple_mean3_stderr = feature_matrix3$FC_LocalSimple_mean3_stderr)

mod <- stan(file = "classifiers/stan/base-model.stan",
...
stan_data <- list(N = nrow(feature_matrix2),
                  y = feature_matrix2$group,
                  DN_HistogramMode_5 = feature_matrix2$DN_HistogramMode_5,
                  DN_HistogramMode_10 = feature_matrix2$DN_HistogramMode_10,
                  CO_f1ecac = feature_matrix2$CO_f1ecac,
                  CO_FirstMin_ac = feature_matrix2$CO_FirstMin_ac,
                  CO_HistogramAMI_even_2_5 = feature_matrix2$CO_HistogramAMI_even_2_5,
                  CO_trev_1_num = feature_matrix2$CO_trev_1_num,
                  MD_hrv_classic_pnn40 = feature_matrix2$MD_hrv_classic_pnn40,
                  SB_BinaryStats_mean_longstretch1 = feature_matrix2$SB_BinaryStats_mean_longstretch1,
                  SB_TransitionMatrix_3ac_sumdiagcov = feature_matrix2$SB_TransitionMatrix_3ac_sumdiagcov,
                  PD_PeriodicityWang_th0_01 = feature_matrix2$PD_PeriodicityWang_th0_01,
                  CO_Embed2_Dist_tau_d_expfit_meandiff = feature_matrix2$CO_Embed2_Dist_tau_d_expfit_meandiff,
                  IN_AutoMutualInfoStats_40_gaussian_fmmi = feature_matrix2$IN_AutoMutualInfoStats_40_gaussian_fmmi,
                  FC_LocalSimple_mean1_tauresrat = feature_matrix2$FC_LocalSimple_mean1_tauresrat,
                  DN_OutlierInclude_p_001_mdrmd = feature_matrix2$DN_OutlierInclude_p_001_mdrmd,
                  DN_OutlierInclude_n_001_mdrmd = feature_matrix2$DN_OutlierInclude_n_001_mdrmd,
                  SP_Summaries_welch_rect_area_5_1 = feature_matrix2$SP_Summaries_welch_rect_area_5_1,
                  SB_BinaryStats_diff_longstretch0 = feature_matrix2$SB_BinaryStats_diff_longstretch0,
                  SB_MotifThree_quantile_hh = feature_matrix2$SB_MotifThree_quantile_hh,
                  SC_FluctAnal_2_rsrangefit_50_1_logi_prop_r1 = feature_matrix2$SC_FluctAnal_2_rsrangefit_50_1_logi_prop_r1,
                  SC_FluctAnal_2_dfa_50_1_2_logi_prop_r1 = feature_matrix2$SC_FluctAnal_2_dfa_50_1_2_logi_prop_r1,
                  SP_Summaries_welch_rect_centroid = feature_matrix2$SP_Summaries_welch_rect_centroid,
                  FC_LocalSimple_mean3_stderr = feature_matrix2$FC_LocalSimple_mean3_stderr,
...
rm(feature_matrix_cobre, feature_matrix1, feature_matrix2, priors)

# Fit model

mod2 <- stan(file = "classifiers/stan/informed-model.stan",
             data = stan_data, iter = 4000, chains = 3, seed = 123,
             control = list(max_treedepth = 15))
...
as.data.frame(mod2) %>%
  ...
  labs(title = "Posterior distributions for SonyAIBORobotSurface1 data with informative priors",
       subtitle = "Bayesian logistic regression model run in Stan with 3 chains and 4,000 iterations per chain. Histogram binwidth = 0.1 and scaled to max of 1",
       x = "Coefficient Value",
       y = "Density") +
  theme_bw() +
